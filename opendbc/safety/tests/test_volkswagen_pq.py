...
class TestVolkswagenPqStockSafety(TestVolkswagenPqSafetyBase):
  ...
  FWD_BLACKLISTED_ADDRS = {0: [MSG_BREMSE_8, MSG_MOTOR_2, MSG_BREMSE_11, MSG_EPB_1], 2: [MSG_HCA_1, MSG_LDW_1, MSG_ACC_SYSTEM, MSG_ACC_GRA_ANZEIGE, MSG_BREMSE_8, MSG_BREMSE_11, MSG_MOTOR_2, MSG_EPB_1]}
