...
def get_scc11_values(enabled, set_speed, idx, hud_control, main_cruise_enabled):
  return {
...
def create_acc_commands(packer, enabled, accel, upper_jerk, idx, hud_control, set_speed, stopping, long_override, use_fca, main_cruise_enabled, ESCC: Escc = None):
  commands = []

  scc11_values = get_scc11_values(enabled, set_speed, idx, hud_control, main_cruise_enabled)
