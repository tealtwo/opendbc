...
def create_acc_buttons_control(packer, bus, gra_stock_values, cancel=False, resume=False, accel=False, decel=False):
...
def stock_acc_control_value(main_switch_on, acc_faulted, long_active):
  if long_active:
    acc_control = 1
  elif main_switch_on:
    acc_control = 2
